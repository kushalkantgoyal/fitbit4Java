...
public class ActivityTemplate extends AbstractFitbitApiOperations implements ActivityOperations {
	...
	//Heart
	@Override
	public IntradaySummary getIntradayHeart(DetailLevel detailLevel, Date baseDate) {
		return getIntradayHeart(detailLevel, TimeUtils.LOCAL_DATE_FORMATTER.format(baseDate), 
				null, null);
	}

	@Override
	public IntradaySummary getIntradayHeart(DetailLevel detailLevel, String baseDate) {
		return getIntradayHeart(detailLevel, baseDate, null, null);
	}

	@Override
	public IntradaySummary getIntradayHeart(DetailLevel detailLevel, Date baseDate, Date startTime, Date endTime) {
		return getIntradayHeart(detailLevel, TimeUtils.LOCAL_DATE_FORMATTER.format(baseDate), 
				TimeUtils.LOCAL_TIME_HOURS_MINUTES_FORMATTER.format(startTime),
				TimeUtils.LOCAL_TIME_HOURS_MINUTES_FORMATTER.format(endTime));
	}
	...
	@Override
	public IntradaySummary getIntradayHeart(DetailLevel detailLevel, String baseDate, String startTime, String endTime) {
		return getData(ResourceType.HEART, detailLevel, baseDate , startTime, endTime);
	}
}